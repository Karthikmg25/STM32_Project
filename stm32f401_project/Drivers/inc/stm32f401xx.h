...
/*
 * Base addresses of Flash and SRAM memories for STM32F4016xx
 * Flash: Up to 512KB
 * SRAM1: 96KB
 *
 */
...
#define SRAM_BASE_ADDR                      0x20000000U     /*!< SRAM1 base address (112KB) */
#define ROM_BASE_ADDR                       0x1FFF0000U    /*!< System memory (ROM) base address */
 ...
 * STM32F401xx has GPIO ports A to H (no GPIOF & GPIOG)
 */
...
/*
 *   Peripheral register definition structure for TIMER2-5
 */
typedef struct
{
...
#define TIM2          ((TIMER2_5_Reg_t*)(TIM2_BASEADDR))
#define TIM3          ((TIMER2_5_Reg_t*)(TIM3_BASEADDR))
#define TIM4          ((TIMER2_5_Reg_t*)(TIM4_BASEADDR))
#define TIM5          ((TIMER2_5_Reg_t*)(TIM5_BASEADDR))
...
/*
 *   Clock Enable Macros for TIMER2-5
 */
 ...
 * STM32F401xx has 6 GPIO ports A-H only
 */
